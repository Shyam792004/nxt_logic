...
//find only the first index value
...
//find all the index value that matches
...
//includes-boolean,indexOf-current index ,if gteh element not found return -1
